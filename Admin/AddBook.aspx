<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddBook.aspx.cs"
    Inherits="LMS5.Admin.CreateBook" MasterPageFile="~/Site.master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    min-width: 600px;
    margin: 20px auto;
    margin-bottom: 120px; /* ensure buttons are above sticky footer */
}
